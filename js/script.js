...
function makeCar(make,country,img = 'images/car-default.jpg',special = true,model = 'new model',price = 10000,type = 'sedan',trans = 'automatic',gas = '50') {
    const car = new Car(make, country, img, special, model, price, type, trans, gas);
    cars.push(car)
}
// produce cars
function produceCars(){
    makeCar('chevy', 'american','images/luxury-3.jpg');
    makeCar('mercedes', 'german','images/luxury-1.jpeg', true);
    makeCar('mercedes', 'german','images/luxury-2.jpeg');
    makeCar('mercedes', 'german','images/luxury-3.jpeg', false, 'some model');
    makeCar('mercedes', 'german','images/luxury-4.jpeg', undefined, 'other model');
    makeCar('mercedes', 'german','images/luxury-5.jpeg', false);
    makeCar('ford', 'american','images/utility-1.jpeg');
    makeCar('ford', 'american','images/utility-2.jpeg', false);
    makeCar('ford', 'american','images/utility-3.jpeg', false);
    makeCar('ford', 'american','images/utility-4.jpeg', false);
    makeCar('ford', 'american','images/utility-5.jpeg', false);
}
produceCars();
// console.log(cars);
// special cars
